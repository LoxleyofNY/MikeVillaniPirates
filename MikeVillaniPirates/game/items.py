...
class Cutlass(Item):
    def __init__(self):
        ...
        self.description = ("A weathered cutlass with a gleaming, curved blade, telling tales of countless skirmishes on the high seas.")
        self.damage = (10,60)
        self.skill = "swords"
        self.verb = "slash"
        self.verb2 = "slashes"
...
class BelayingPin(Item):
    def __init__(self):
        ...
        self.description = ("A sturdy pin, worn smooth by the hands of sailors, doubling as a tool of both rigging and unexpected defense during swashbuckling brawls")
        self.damage = (5,30)
        self.skill = "melee"
        self.verb = "bash"
        self.verb2 = "bashes"
...
class Flintlock(Item):
    def __init__(self):
        ...
        self.description = ("A well-worn flintlock pistol, its barrel marked by the salt spray of the open sea, a reliable companion for any pirate daring enough to face the uncertainties of the pirate life.")
        self.damage = (10,100)
        self.firearm = True
        self.charges = 1
        self.skill = "guns"
